...
class CInputMain : public CInputProcessor
{
	...
	protected:
		...
		void		SpecularColor(LPCHARACTER ch, const char* c_pData);
#endif
		...
		void		NewTitleSystem(LPCHARACTER ch, const char* c_pData);
		void		NewAlignSystem(LPCHARACTER ch, const char* c_pData);
#endif
