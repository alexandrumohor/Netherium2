...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_NEW_TITLE, sizeof(TPacketCGSetNewTitle), "NewTitleSystem", false);
	Set(HEADER_CG_NEW_ALIGN, sizeof(TPacketCGSetNewAlign), "NewAlignSystem", false);
#endif
#ifdef ENABLE_SPECULAR_SYSTEM
	Set(HEADER_CG_SPECULAR_COLOR,			sizeof(TPacketCGSpecularColor),			"SpecularColor",	false);
#endif
}
