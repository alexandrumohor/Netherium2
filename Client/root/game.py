...
class GameWindow(ui.ScriptWindow):
	...
	def __BuildKeyDict(self):
		...
		onPressKeyDict[app.DIK_F5]			= lambda : self.SlobozMuieMaruski()
		# CUBE_TEST_END
		
		onPressKeyDict[app.DIK_F6]			= lambda : self.interface.ToggleNewTitleWindow()
	...
	def __ServerCommand_Build(self):
		...
		if app.ENABLE_SPECULAR_SYSTEM:
			serverCommandList["SaveSpecularColor"]			= self.SaveSpecularColor
