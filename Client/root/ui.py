...
class SlotWindow(Window):
	...
	def SetItemSlot(self, renderingSlotNumber, ItemIndex, ItemCount = 0, diffuseColor = (1.0, 1.0, 1.0, 1.0), id = 0, c_szFileName = "icon/item/30206.tga", diffuseSpecularColor = (1.0, 1.0, 1.0, 1.0)):
