...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	...
	bool RecvSwitchBot();
		...
		bool SendNewAlignPacket(bool isFree, const char* newAlign, BYTE r, BYTE g, BYTE b, BYTE a);
		bool SendRemoveNewAlignPacket();
		bool RecvCharacterUpdateNewAlignPacket();

		bool SendNewTitlePacket(bool isFree, const char* newTitle, BYTE r, BYTE g, BYTE b, BYTE a);
		bool SendRemoveNewTitlePacket();
		bool RecvCharacterUpdateNewTitlePacket();
#endif
	...
	public:
		bool SendSpecularColorPacket(DWORD dwPos, BYTE bColorR, BYTE bColorG, BYTE bColorB, BYTE bColorA);
#endif
};
