...
#ifdef ENABLE_NEW_TITLE_SYSTEM
		void UpdateActorNewTitle(DWORD dwVID, const char* newTitle, const BYTE* bCustomColor);
		void UpdateActorNewAlign(DWORD dwVID, const char* newAlign, const BYTE* bColor);
#endif
