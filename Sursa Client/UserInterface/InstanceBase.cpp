...
bool CInstanceBase::Create(const SCreateData& c_rkCreateData)
{
	...
	if (IsPC())
	{
		...
		m_stNewTitle = c_rkCreateData.m_stNewTitle;
		UpdateNewTitleName(c_rkCreateData.m_stNewTitle.c_str());
		memcpy(m_bNewTitleColor, c_rkCreateData.m_bNewTitleColor, sizeof(m_bNewTitleColor));

		m_stNewAlign = c_rkCreateData.m_stNewAlign;
		UpdateNewAlignName(c_rkCreateData.m_stNewAlign.c_str());
		memcpy(m_bNewAlignColor, c_rkCreateData.m_bNewAlignColor, sizeof(m_bNewAlignColor));
#endif
