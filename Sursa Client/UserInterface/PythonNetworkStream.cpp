...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		...
		Set(HEADER_GC_SWITCHBOT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCSwitchBotReceive), STATIC_SIZE_PACKET));
			...
			Set(HEADER_GC_UPDATE_NEW_TITLE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCUpdateNewTitle), STATIC_SIZE_PACKET));
			Set(HEADER_GC_UPDATE_NEW_ALIGN, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCUpdateNewAlign), STATIC_SIZE_PACKET));
#endif
		}
};
