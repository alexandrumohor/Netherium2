...
enum
{
	...
	HEADER_CG_NEW_ALIGN = 84,
	HEADER_CG_NEW_TITLE = 85,
#endif
	//HEADER_BLANK86								= 86,
	//HEADER_BLANK87								= 87,
	//HEADER_BLANK88								= 88,
...
#ifdef ENABLE_NEW_TITLE_SYSTEM
		HEADER_GC_UPDATE_NEW_ALIGN = 103,
		HEADER_GC_UPDATE_NEW_TITLE = 104,
#endif
    HEADER_GC_TIME                              = 106,
...
#ifdef ENABLE_NEW_TITLE_SYSTEM
typedef struct SCharacterNewTitle
{
	char	szName[NEW_TITLE_MAX_NUM + 1];
	BYTE	bCustomColours[NEW_COLOR_MAX_NUM + 1];
} TCharacterNewTitle;

typedef struct SCharacterNewAlign
{
	char	szName[NEW_ALIGN_MAX_NUM + 1];
	BYTE	bColours[NEW_COLOR_MAX_NUM + 1];
} TCharacterNewAlign;
#endif
...
#endif
#ifdef ENABLE_NEW_TITLE_SYSTEM
	TCharacterNewTitle newTitle;
	TCharacterNewAlign newAlign;
#endif
...
#ifdef ENABLE_NEW_TITLE_SYSTEM
typedef struct packet_update_newtitle
{
	BYTE	header;
	DWORD	dwVID;
	TCharacterNewTitle newTitle;
} TPacketGCUpdateNewTitle;

typedef struct packet_set_newtitle
{
	BYTE	header;
	bool	isFree;
	TCharacterNewTitle newTitle;
} TPacketCGSetNewTitle;

typedef struct packet_update_newalign
{
	BYTE	header;
	DWORD	dwVID;
	TCharacterNewAlign newAlign;
} TPacketGCUpdateNewAlign;

typedef struct packet_set_newalign
{
	BYTE	header;
	bool	isFree;
	TCharacterNewAlign newAlign;
} TPacketCGSetNewAlign;
#endif
